  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6">
      ...
      <div className="w-full max-w-md glass-panel rounded-3xl p-8 rim-light ambient-glow">
        <h1 className="font-heading text-2xl font-bold text-on-surface mb-2">Welcome Back</h1>
        <p className="text-on-surface-variant text-sm mb-8">Login to manage your AI digital workers.</p>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <Link href="#" className="text-[10px] font-bold uppercase tracking-widest text-secondary hover:underline">Forgot?</Link>
            </div>
            <input
              type="password"
              required
        ...
        <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs">
                <span className="bg-surface-container-lowest px-4 text-on-surface-variant font-bold uppercase tracking-[0.2em] text-[10px]">Or continue with</span>
            </div>
        </div>
        ...
        <button 
            ...
            disabled={loading}
            className="w-full py-4 bg-surface-container border border-outline-variant rounded-xl font-bold text-[10px] uppercase tracking-widest text-on-surface hover:bg-surface-container-high transition-colors flex items-center justify-center gap-3 mb-8"
        >
        ...
        <div className="text-center">
          <p className="text-sm text-on-surface-variant">
            ...
            <Link href="/register" className="text-secondary font-bold hover:underline">Create an Account</Link>
          </p>
        </div>
      </div>
